...
import { MECHANIC_FINAL_STATUSES, MECHANIC_STATUS_ENUM, WORKLOG_LOCKED_STATUSES } from '../../../shared/data-modals/booking-status';
...
const fmtCur = (value) => formatCurrencyIN(Number(value), { minimumFractionDigits: 2, maximumFractionDigits: 2 });

// â”€â”€â”€ Work Log Section â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export default function MechanicJobDetails() {
	...
	const rawStatus = normalizeStatusKey(job?.statusLabel);
	const isFinalState = MECHANIC_FINAL_STATUSES.includes(rawStatus);
	const isWorklogLocked = WORKLOG_LOCKED_STATUSES.includes(rawStatus);

	const updateStatus = async (statusKey) => {
		try {
			setUpdating(true);
			await mechanicJobService.updateStatus(id, {
				newStatus: MECHANIC_STATUS_ENUM[statusKey],
