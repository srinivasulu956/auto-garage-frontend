import { FUEL_META } from '../constants/vehicleConstants';
import { fmtDate } from '../utils/vehicleFormatters';

export default function VehicleCard({ vehicle, onEdit, onDelete, onReactivate, inactive = false }) {
